//===--- ImageInspectionWASM.cpp - ELF image inspection --------------------===//
//
...
/// \file
///
/// This file includes routines that interact with ld*.so on WASM-based platforms
/// to extract runtime metadata embedded in dynamically linked WASM images
...
// As WASM images are loaded, ImageInspectionInit:sectionDataInit() will call
