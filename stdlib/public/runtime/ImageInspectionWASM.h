...
/// \file
///
/// WASM specific image inspection routines.
///
//===----------------------------------------------------------------------===//

#ifndef SWIFT_RUNTIME_IMAGEINSPECTIONWASM_H
#define SWIFT_RUNTIME_IMAGEINSPECTIONWASM_H
...
#endif // SWIFT_RUNTIME_IMAGE_INSPECTION_WASM_H
