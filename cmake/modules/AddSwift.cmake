...
function(_add_variant_c_compile_link_flags)
  ...
  if("${CFLAGS_SDK}" STREQUAL "WEBASSEMBLY")
    list(APPEND result
       "-D_GNU_SOURCE=1"
...
function(_add_variant_link_flags)
  ...
  elseif("${LFLAGS_SDK}" STREQUAL "WEBASSEMBLY")
    # nothing yet
  else()
...
#
# SWIFT_MODULE_DEPENDS_WEBASSEMBLY
#   Swift modules this library depends on when built for Haiku.
#
# FRAMEWORK_DEPENDS
#   System frameworks this library depends on.
...
function(add_swift_library name)
  ...
  list_replace(SWIFTLIB_TARGET_SDKS ALL_POSIX_PLATFORMS "ALL_APPLE_PLATFORMS;ANDROID;CYGWIN;FREEBSD;LINUX;HAIKU;WEBASSEMBLY")
  ...
  if(SWIFTLIB_TARGET_LIBRARY)
    ...
    foreach(sdk ${SWIFTLIB_TARGET_SDKS})
      ...
      foreach(arch ${SWIFT_SDK_${sdk}_ARCHITECTURES})
        ...
        elseif("${sdk}" STREQUAL "WEBASSEMBLY")
          list(APPEND swiftlib_module_depends_flattened
               ${SWIFTLIB_SWIFT_MODULE_DEPENDS_WEBASSEMBLY})
        endif()
